...
public class ProfileController {
    ...
    public void initialize() {
        ...
        if (imagePath != null && !imagePath.isEmpty()) {
            try {
                profileImage = new Image("file:" + imagePath); // Add file: prefix
            } catch (Exception e) {
                System.out.println("Failed to load user profile image: " + imagePath);
    ...
    private void handleLogoutAction() {
        try {
            services.GoogleLoginService.logoutGoogleUser();
